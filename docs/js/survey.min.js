...
async function showResults() {
  ...
  try {
    ...
    if (attemptNumber === 1) {
      ...
      introHtml = `
        <h4>Schön, dass Sie verschiedene Kurse absolviert haben und nochmals an der Umfrage teilgenommen haben. Im Folgenden sehen Sie wieder Ihren durchschnittlichen Score für die eingeschätzten digitalen Kompetenzen, nun aber für die zweite Befragung.<br></h4>
        <p><strong>Ihr Kompetenzscore beträgt ${overallScore}%</strong></p>
        <h3>Kompetenzdiagramm</h3>
      ...
      introHtml = `
        <h4>Schön, dass Sie nochmals an der Umfrage teilgenommen haben. Im Folgenden sehen Sie wieder Ihren durchschnittlichen Score für die eingeschätzten digitalen Kompetenzen, nun aber für die abschließende Befragung.<br></h4>
        <p><strong>Ihr Kompetenzscore beträgt ${overallScore}%</strong></p>
        <h3>Kompetenzdiagramm</h3>
