...
const surveyData = [
  {
    ...
    questions: [
      ...
      //   ],
      //   dependsOn: { questionId: 'q0_2', value: 'Ja' },
      //   required: !0,
      // },
      // {
      ...
      //   type: 'text',
      //   dependsOn: { questionId: 'q0_2', value: 'Nein' },
      //   required: !0,
      // },
      {
      ...
      {
        text: 'Mit welchem Durchschnitt hast du dein Abitur abgeschlossen? Bitte gebe hier den exakten Wert an, z.B. 2.3.',
        type: 'number',
        min: 1.0,
        max: 4.0,
        step: 0.1,
  ...
  },
  {
    ...
    questions: [
      ...
      {
        text: 'Ich kann unterscheiden, ob ein System KI-basiert ist oder nicht.',
        type: 'scale',
        required: !0,
      },
      {
        text: 'Ich kann verschiedene digitale Produkte mit KI erstellen.',
        type: 'scale',
        required: !0,
      },
      {
        text: 'Ich kann die Nutzen und Risiken eines KI-Tools für unsere Gesellschaft beurteilen.',
        type: 'scale',
        required: !0,
      },
      {
        text: 'Ich kann die Nutzen und Risiken eines KI-Tools für meine persönliche Entwicklung beurteilen.',
        type: 'scale',
        required: !0,
      },
    ],
...
'undefined' != typeof module && module.exports
  ...
  : 'undefined' != typeof window && (window.surveyData = surveyData)
